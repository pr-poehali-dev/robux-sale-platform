...
const Index = () => {
  ...
  const handlePayment = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://functions.poehali.dev/a4b67e55-a7d1-4b02-9f57-3e8b10963890', {
        method: 'POST',
        headers: {
              ...
              <form onSubmit={handlePayment} className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <p className="text-sm text-center text-muted-foreground">
                    После нажатия кнопки вы будете перенаправлены на защищённую страницу оплаты Robokassa
                  </p>
                </div>
